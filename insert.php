...
$query=mysqli_query($con, "insert into tblusers(FirstName,LastName,ProfilePic) value('$fname','$lname','$imgnewfile' )");
if ($query) {
...
<div class="signup-form">
	...
	<div class="text-center">View Aready Inserted Picture!!  <a href="index.php">View</a></div>
</div>
</body>
</html>